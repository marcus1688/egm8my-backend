...
const cmdWebLaunchGameUrl = "https://edmyr.fts368.com";
const cmdMobileLaunchGameUrl = "https://edmyrsmart.fts368.com";
...
router.post("/api/cmd368/deductbalance", async (req, res) => {
  try {
...
router.post("/api/cmd368/updatebalance", async (req, res) => {
  try {
    const { balancePackage, method, packageId, dateSent } = req.body;
